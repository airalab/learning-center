...
Голосуем акциями за то, чтобы токен совета директоров был принят
...
ether_credits.transfer(1000, bod.address);
```
...
voting.vote(10, {from:web3.eth.accounts[2], gas:300000})
```
