...
Create a new market agent contract with the help of the market regulator
...
Execute the lesson. Don't forget to pass the market address and the address of the DAOMarketAgent 
