...
builder.create(dao_addr, core.get('Mars colony shares'), core.get('Ether funds'), 0, {from: eth.accounts[0], gas: 3000000, value: builder.buildingCostWei()})
...
var builder = web3.eth.contract(BuilderTokenEmission).at(core.get("Token emission builder"));
builder.create('Directors voting token', 'DVT', 0, 30, 0, {from: eth.accounts[0], gas: 2000000, value: builder.buildingCostWei()})
builder.getLastContract()
```
...
var bod = web3.eth.contract(BuilderBoardOfDirectors).at(core.get("Board of Directors"));
...
```js
bod.fund(web3.eth.accounts[0], 1000, 'sample description here', 1467968200, 1467971988, {from: web3.eth.accounts[0], gas: 2000000})
```
