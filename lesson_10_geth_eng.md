...
Add Token emission builder contract address to registry
...
Add new lots to DAO registry to make them tradable
...
Execute lesson. Don't forget to pass Market contract address
