...
- Отправить на адрес контракта `ShareSale` количество акций предлагаемых для продажи по контракту.
- Отправить на адрес контракта `ShareSale` количество эфиров, требуемое для сделки.
