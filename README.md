...
После установки клиента сети, выполните синхронизацию с **тестовой сетью** и обратитесь к контракт Airalab в тестовой сети, который отправит вам в ответ небольшое количество эфиров для выполнения следующих уроков.
