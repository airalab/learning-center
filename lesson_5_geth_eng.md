...
builder.create('DAO credit', 'DCT', 0, 100, {from: eth.accounts[0], gas: 1000000, value: builder.buildingCostWei()})
...
var lesson = web3.eth.contract(Lesson_5).at(learning_center.getModule("Lesson_5");
