...
Create `ShareSale` contract using builder
...
Send shares to `ShareSale` contract
...
Check that shares are received

```js
shares.balanceOf(web3.eth.accounts[0])
```

Execute lesson. Don't forget to pass `shareSale` address
